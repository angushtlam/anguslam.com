...
I don't really intend this to act as a comprehensive travel guide, but more so an outline to try and understand beyond what Miami is canonically known to tourists. There's a sprinkle of locations and restaurants that I think add outsized character or cultural representation to the experience of the city, but it's not emcompassing of everything a person should do when visiting. Each visit is different!

I also wrote up most of this prior to the trip and revised during it, so I don't claim to be an expert. I hope to revisit this in the future and make modifications that can cover most of its uniqueness within just a few days of visiting. The qualities I chose to emphasize are: historical and modern architecture, a perfect beach day, museums, and Latin American and Haitian influences.
...
Ocean Drive is probably most iconically known as the Spring Break destination with restaurants and bars up and down the street. It's also known for its colorful art deco architecture, landing it a spot on the U.S. National Register of Historic Places.
...
- Española Way (outdoor options, Spanish revival architecture lined with restaurants)
- Lincoln Road (outdoor options, restaurants, bars, occasionally some farmer's market and street food stalls)
- World Erotic Art Museum (indoors, museum)
- The Bass Museum of Art (indoors, museum)

Restaurants:

- Ocean Drive is lined with restaurants, you will not go hungry, but I actually didn't really see anything that particularly stood out to me. If you didn't like anything you see, it looks like Sunset Harbour a little further away has less-touristy options.
- Mercato della Pescheria (outdoor options, $45pp, Italian)
- Taquiza (outdoor options, $15pp, fun tacos with black-colored tortillas)
...
- Brickell Avenue Bridge (outdoors, drawbridge)
  - _The bridge on South Miami Avenue is also a drawbridge, but you can watch the boats pass by in Brickell Point (read: park), which is way nicer imo._
...
- Dolores but you can call me Lolita (outdoor options, $40pp, New American, rooftop)
- Novecento (outdoor options, $30pp, Argentinian)
- Garcia's Seafood Grille & Fish Market (outdoor options, $30pp, seafood, riverfront views)
- Versailles Restaurant Cuban Cuisine (indoors, $15pp, Cuban)
  - _"The World's Most Famous Cuban Restaurant"_
- Azucar Ice Cream - Little Havana (takeout, $10pp, ice cream)
...
- Panther Coffee (outdoor options, $10pp, coffee)
- Chef Creole Seasoned Restaurant (indoors, $30pp, Creole)
